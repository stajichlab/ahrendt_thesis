...
\indent The data presented in the Appendix appears in \cite{James2013}. The co-author, Dr. Jason Stajich, listed in this publication directed and supervised the research which forms the basis for this dissertation.\\
...
% INTRODUCTION %
%%%%%%%%%%%%%%%%
\include{./Chapter_Introduction/tex/Ahrendt_thesis_Intro}
...
\include{./Chapter_RhodStruct/tab/Ahrendt_thesis_ChRhodStruct_Tabs}
...
\include{./Chapter_RhodAux/tab/Ahrendt_thesis_ChRhodAux_Tabs}
...
\include{./Chapter_Coelomomyces/tab/Ahrendt_thesis_ChCoelomomyces_Tabs}
...
\include{./Chapter_Inhibition/tab/Ahrendt_thesis_ChInhibition_Tabs}

%%%%%%%%%%%%%%%
% CONCLUSIONS %
%%%%%%%%%%%%%%%
\include{./Chapter_Conclusions/tex/Ahrendt_thesis_Conclusions}
...
\include{./Appendix/tab/Ahrendt_thesis_AppData_Tabs}
\end{document}
