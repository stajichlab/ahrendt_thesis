...
greate ecological importance. This phylum also contains four subphyla
...
\indent Revisions of fungal phylogenetics continued through the 20th
century and included Alexopolous's series on Introductory Mycology in
the 1950s. [JS: Are you planning to expand, a 1 sentence paragraph? -
  the book is really a summary of published literature so I would
  expect more primary literature in your review of this; see also
  things like DOI:10.1126/science.8469985 ] \\

\indent Significant microscopy work was carried out on chytrid species
as early as 1953 by Koch and others, which allowed for the discussion
of zoosporic ultrastructure characters. In the 1970s, the then recent
technology of electron microscopy allowed for finer grain examinations
of chytrid ultrastructure. [JS: citations?] \\

\indent In 1993, Mims and Blackwell for fourth edition (1996) using
DNA-based phylogentics (specifically SSU rDNA). Importantly,
established Fungi as monophyletic, established chytrids as Fungi, and
excluded other heterokont flagellates (eg oomycetes). [JS: The book is
  not the primary citation for this - see Bruns et al 1992
  DOI: 10.1016/1055-7903(92)90020-H , Bruns et al 1991
  http://www.jstor.org/stable/2097273 ]. \\

\indent In 1999, James et al attempted to reconcile the previous
ultrastructure-based phylogeny (using characters such as zoospore
discharge, thallus development, ultrastructural features) with modern
molecular techniques (eg ssu rDNA) used in assessing phylogentic
relationships in other fungal groups. [JS: Also cite James et al 2006
  Nature and James et al 2006 Mycologia] \\
...
\indent By 2006, at the time of the establishment of the Deep Hypha
coordination network, the Chytridiomycota was accepted as one of the
four major fungal phyla (alongside the Zygomycota, Basidiomycota, and
Ascomycota). [JS: cite James et al 2006, Hibbett 2007?]\\
...
collection and culturing methods. \\
...
(http://www.broadinstitute.org/). The resulting assembly is 23.72 Mb,
...
(http://genomeportal.jgi-psf.org/Batde5/Batde5.home.html). This
assembly is 24.3 Mb and represents 8.74X coverage. \\

\indent As part of the push to understand the Origins of
Multicellularity [JS: ADD DOI: 10.1016/j.tig.2007.01.005], the genomes for the \textit{Allomyces macrogynus}
(Blastocladiomycete) and the exclusively terrestrial
\textit{Spizellomyces punctatus} (Chytridiomycete) (24.1 Mb) were
sequenced by the Broad Institute in 2009. \\
...
of pathogenicity in \textit{Bd} \cite{Joneson2011}.[Also summarize and
  cite Longcore 2011 -
  http://www.ingentaconnect.com/content/mtax/mt/2012/00000118/00000001/art00049]
...
\cite{Youssef2013}. \textit{Piromyces} and \textit{Orpinomyces} are
...
Cryptomycota and Microsporidian lineages. [JS: INDICATE BRIEFLY THAT YOU
...
Project (http://1000.fungalgenomes.org) with plans to sequence at
additional chytrid fungi, including \textit{Operculomyces laminatus}
JEL223, \textit{Rhizoclosmatium hyalinus} JEL800, and
\textit{Obelidium mucronatum} JEL802. [JS: THERE ARE MORE see http://genome.jgi.doe.gov/pages/fungi-1000-projects.jsf] \\
...
the full extend of photosensing in zoosporic fungi has not been fully
...
\end{itemize}
\indent Certain insect-associated fungi are pathogenic on
mosquitos. Of these, members of the genus \textit{Coelomomyces} in the
Blastocladiomycota are the only known chytrid entomopathogens. While
...
have allowed it to persist as an interesting avenue of research. [JS:
  How many species described in the genus?]\\
...
the zoospores for motility \cite{Koch1958}. The chytrid flagellar
apparatus is composed of the flagellar stalk (axoneme), the kinetosome
(basal body), and the rootlet system \cite{Barr1981}. Additionally the
characteristic 9+2 arrangment characteristic in other eukaryotic
flagellated organisms persists. [JS: Summarize or more clearly state
  that this is homologous] \\
...
\indent Comparative genomic study of the chytrid flagellar apparatus is presented in Appendix~\ref{app:Flagella}. Included is a collection of genes which serve as a "core chytrid" flagellar geneset, which may prove useful in future assessments of chytrid and other basal fungal genomes.\\
