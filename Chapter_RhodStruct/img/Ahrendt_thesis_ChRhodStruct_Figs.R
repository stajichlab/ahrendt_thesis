...
Tpac2Z73_mdout <- read.table("../dat/Tpac2Z73_retCI_summary.EPTOT",header=T,sep="\t")
Spun00350_mdout <- read.table("../dat/Spun00350_retCI_summary.EPTOT",header=T,sep="\t")
...
plot(Tpac2Z73_mdout,type="l",yaxs="i",xaxs="i",ylim=c(-9000,-2400),col="black",ylab="Potential Energy",cex.lab=2,cex.axis=2)
lines(Spun00350_mdout,yaxs="i",xaxs="i",col="red")
mtext("A", side=3, adj=0, line=1.2, cex=6, font=2)
plot(Tpac2Z73_rms,type="l",yaxs="i",xaxs="i",ylim=c(0,20),col="black",cex.lab=2,cex.axis=2)
lines(Spun00350_rms,yaxs="i",xaxs="i",col="red")
...
boxplot(value~Model + Ligand, data=stacked.dock, col=c("blue","red"),horizontal=T,las=1,cex.axis=0.5,ylim=c(-12,0))
dev.off()
